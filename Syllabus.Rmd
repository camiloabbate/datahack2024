...
* **Week 2 (January 19): Continuation of Cleaning, **
...
* **Week 3 (January 26): Visualization with ggplot2**
  + Topics (R): ggplot2 grammar of graphics, facet wraps, aesthetic mappings, reasons to use ggplot2. Plotting heatmaps, using fill, colours. If time allows: `usmap`, `sf` packages.
